...
public class App {
    ...
    public Cliente solicitarDatosCliente() {
        ...
        Cliente cliente = new Cliente(datosUsuario.getDNI(), datosUsuario.getNombre(), datosUsuario.getApellido(),
                datosUsuario.getEmail(), datosUsuario.getContrasena());
    ...
    public Administrador solicitarDatosAdmin(String TokenAdm) {
        ...
        if (!TokenValido.equals(TokenAdm)) {
            ...
            Administrador admin = new Administrador(datosUsuario.getDNI(), datosUsuario.getNombre(),
                    datosUsuario.getApellido(), datosUsuario.getEmail(), datosUsuario.getContrasena());
    ...
    private Usuario solicitarDatosUsuario() {
        ...
        do {
            ...
            if (!(email.endsWith("@gmail.com") || email.endsWith("@hotmail.com") || email.endsWith("@outlook.com")
                ...
                System.out.println(
                        "Error: El email debe tener una terminación válida (@gmail, @hotmail, @outlook, @yahoo).");
            }
    ...
    public Pelicula solicitarDatosPelicula() {
        ...
        pelicula.setVistas(0);
        pelicula.setPuntaje();

        System.out.printf("Titulo: %s | Género: %s | Director: %s | Duración: %d min\n", pelicula.getTitulo(),
                pelicula.getGenero(), pelicula.getDirector().getNombre(), pelicula.getDuracion().toMinutes());
    ...
    public Reseña solicitarDatosResena(Usuario usuario) {
        ...
        System.out.printf("Usuario: %s | Película ID: %d | Comentario: %s | Puntaje: %d\n",
                reseña.getUsuario().getNombre(), reseña.getIDContenido(), reseña.getComentario(),
